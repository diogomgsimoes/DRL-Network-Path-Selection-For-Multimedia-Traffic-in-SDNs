...
for epoch in range(3000):
    ...
    if epoch % 10 == 0:
        torch.save(onlineQNetwork.state_dict(), 'dueling-dqn_policy_set1_32r_4sync')
...
for size in sizes:
    ...
    plt.savefig('dueling-dqn_policy_set1_32r_4sync_{}.png'.format(size))